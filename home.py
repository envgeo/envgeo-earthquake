...
- `0.3.0` (2026-09-17)
  - **Changed:** App and page version labels are now consistently displayed as `0.3.0`.
  - **Planned:** English/Japanese and Simple/Advanced pages remain separate while shared, testable helpers are extracted gradually.
